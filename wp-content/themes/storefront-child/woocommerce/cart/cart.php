  ...
  <div class="self_clear">
    <div class="coupon-block">
      <?php if ( wc_coupons_enabled() ) { ?>
        <div class="coupon">
          <input type="text" name="coupon_code" class="input-text float-left" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'woocommerce' ); ?>" /> <input type="submit" class="button btn btn-primary float-left" name="apply_coupon" value="<?php esc_attr_e( 'Apply', 'woocommerce' ); ?>" />
