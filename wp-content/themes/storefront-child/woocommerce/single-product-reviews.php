...
<div id="reviews" class="woocommerce-Reviews">
    ...
    <div id="review_form_wrapper" class="hidden">
      <div class="col-full review-form-inner-wrapper">
        <div class="review-form-close review-form-toggle">
        ...
        <div id="review_form">
          <?php
            ...
            $comment_form['comment_field'] .= '<p class="comment-form-comment"><label for="comment">' . esc_html__( 'Review', 'woocommerce' ) . ' <span class="required">*</span></label><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" required></textarea></p>';
